...
export default function Products() {
  ...
  const text =
    'Para cambiar el codigo del producto debera eliminarlo y volverlo a crear';
  ...
  const columns: GridColDef[] = [
    {
      ...
      sortable: false,
      renderCell: (params) => {
        const onClick = (e: any, submitFunction: () => void) => {
        ...
        return (
          ...
          >
            <Button
              size="small"
              onClick={(e) => onClick(e, () => setEditOpen(true))}
            >
              <EditIcon></EditIcon>
            </Button>
            <Button
              size="small"
              onClick={(e) => onClick(e, () => setConfirmDeleteOpen(true))}
            >
  ...
  return (
    ...
    >
      <form>
        ...
        <center>
          {emptyField && item.imageUrl === '' && preview === undefined && (
